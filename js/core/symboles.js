...
export const EMOJIS = [
  ...
  {
    nom: 'Frissons et Halloween',
    signes: [
      ['🎃', 'citrouille halloween lanterne automne'],
      ['👻', 'fantôme horreur peur épouvante halloween'],
      ['💀', 'crâne mort horreur noir halloween'],
      ['🧛', 'vampire horreur fantastique halloween'],
      ['🧟', 'zombie horreur apocalypse halloween'],
      ['🦇', 'chauve-souris nuit vampire halloween'],
      ['🕸️', 'toile araignée abandonné halloween'],
      ['🧹', 'balai sorcière halloween ménage'],
      ['😈', 'diable malice tentation halloween'],
      ['👹', 'ogre monstre conte halloween'],
      ['👺', 'gobelin masque japon halloween'],
      ['🐺', 'loup loup-garou forêt conte halloween'],
      ['🌕', 'pleine lune nuit loup-garou halloween'],
      ['⚰️', 'cercueil mort funèbre halloween'],
      ['🪦', 'tombe cimetière mort halloween'],
      ['🩸', 'sang thriller horreur halloween'],
      ['🔪', 'couteau crime polar thriller halloween'],
    ],
  },
  {
    nom: 'Qui lit',
  ...
  },
  {
    ...
    signes: [
      ...
      ['🕷️', 'araignée peur toile halloween'],
